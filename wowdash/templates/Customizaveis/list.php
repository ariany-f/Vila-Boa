    ...
    <div class="col-xxl-12">
        <div class="card h-100 p-0 email-card">
            ...
            <div class="card-body p-0">
                <ul id="customList" class="overflow-x-auto">
                    <?php foreach ($customizaveis as $custom): ?>
                        ...
                        style="display: flex;" 
                        data-titulo="<?= h($custom->titulo) ?>"> 
                            <div class="form-check style-check d-flex align-items-center">
                                <input class="form-check-input radius-4 border border-neutral-400" type="checkbox" name="checkbox">
                            </div>
                            <a target="_blank" href="<?= h($custom->link_iframe) ?>" 
...
<?php $this->start('script'); ?>
    ...
    $('#searchInput').on('input', function () {
        ...
        $('#customList .email-item').each(function () {
