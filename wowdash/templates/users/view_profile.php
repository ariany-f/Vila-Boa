                    ...
                    <div class="tab-pane fade" id="pills-change-passwork" role="tabpanel" aria-labelledby="pills-change-passwork-tab" tabindex="0">
                        <div class="mb-20">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control radius-8" id="your-password" placeholder="Digite a Nova Senha*">
                        ...
                        <div class="mb-20">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control radius-8" id="confirm-password" placeholder="Confirmar Senha*">
