...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/', function (RouteBuilder $builder): void {
        ...
        $builder->scope('/authentication', ['controller' => 'Users'], function ($builder) {
            ...
            $builder->connect('/signout',['action'=>'signout'], ['_name'=> 'signout']);
       ...
       $builder->scope('/dashboard', ['controller' => 'Dashboard'], function ($builder) {
        ...
        $builder->scope('/', ['controller' => 'Home'], function ($builder) {
            ...
            $builder->connect('/',['controller' => 'Home', 'action'=>'index'],['_name'=>'index']);
        ...
        $builder->scope('/user', ['controller' => 'Users'], function ($builder) {
            ...
            $builder->connect('/perfil',['action'=>'viewProfile'],['_name'=>'viewProfile']);
        });
