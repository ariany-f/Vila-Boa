 ...
 * @var \App\Model\Entity\Customizavel $customizavel
 */
?>
<div class="row gy-4">
            ...
            <div class="min-w-450-px d-flex flex-column justify-content-between h-100">
                <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center gap-3 justify-content-between flex-wrap">
                    <div class="d-flex align-items-center gap-2">
                        <a href="<?= $this->Url->build(['_name' => 'listGerenciarCustomizaveis'])?>" class="d-flex align-items-center">
                        ...
                        <h6 class="mb-0 text-lg"><?= h($customizavel->titulo) ?></h6>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="py-16 px-24 border-bottom">
                        <div class="content">
                            <?php if($customizavel->descricao): ?>
                                <div class="text">
                                    <strong><?= __('Descricao') ?></strong>
                                    <blockquote>
                                        <?= $this->Text->autoParagraph(h($customizavel->descricao)); ?>
                                    </blockquote>
                                </div>
                            <?php endif; ?>
                            
                            <iframe height="600px" width="100%" src="<?= $customizavel->link_iframe ?>"></iframe>
                        </div>
                    </div>
                </div>
