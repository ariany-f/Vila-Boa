    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div>
                ...
                <p class="mb-32 text-secondary-light text-lg">Bem-vindo(a), preencha os dados para entrar</p>
            </div>
            <form action="#">
                ...
                <div class="mt-32 text-center text-sm">
                    <p class="mb-0">Don’t have an account? <a href="<?= $this->Url->build(['_name' => 'signup']) ?>" class="text-primary-600 fw-semibold">Sign Up</a></p>
                </div>
